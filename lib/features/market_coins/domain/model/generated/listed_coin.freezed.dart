...
class _$ListedCoinImpl implements _ListedCoin {
  ...
  @override
  String toString() {
    return 'ListedCoin(id: $id, status: $status, baseAsset: $baseAsset, quoteAsset: $quoteAsset, hasIcon: $hasIcon)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, status, baseAsset, quoteAsset, hasIcon);
